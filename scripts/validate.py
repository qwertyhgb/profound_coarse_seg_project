#!/usr/bin/env python
"""Validate a checkpoint on a validation split."""
...
def main():
    ...
    parser.add_argument("--split", default=None, help="Override validation split file, e.g. data/splits/5fold/fold_0/val.txt")
    ...
    ds = PICAINPZDataset(cfg["data"]["processed_root"], split, mode="val")
    save_csv = args.save_csv or str(Path(args.checkpoint).parent.parent / "logs" / "val_cases.csv")
